...
generator = cms.EDFilter(
    ...
    # initial temperature of QGP; allowed range [0.2,2.0]GeV;
    qgpInitialTemperature = cms.double(1.),
    # proper time of QGP formation; allowed range [0.01,10.0]fm/c;
    qgpProperTimeFormation = cms.double(0.1),
    hadronFreezoutTemperature = cms.double(0.125),
    # if true, perform partonic radiative en loss
    doRadiativeEnLoss = cms.bool(True),
    doCollisionalEnLoss = cms.bool(True),
    # number of active quark flavors in qgp; allowed values: 0,1,2,3
