...
# with command line options: Configuration/GenProduction/python/gemini_fragment.py --mc --eventcontent GEN --datatier GEN --conditions 150X_mcRun3_2025_forOO_realistic_v7 --beamspot Nominal2025OOCollision --step GEN --nThreads 1 --scenario HeavyIons --geometry DB:Extended --era Run3_2025_OXY --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/gemini_fragment.py nevts:1'),
...
process.GENoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('gemini_Angantyr_CP5_OO_5362GeV_pthat15_py_GEN.root'),
