...
# with command line options: Configuration/GenProduction/python/MinBias_Pythia_Angantyr_CP5_OO_5362GeV.py --mc --eventcontent GEN --datatier GEN --conditions 150X_mcRun3_2025_forOO_realistic_v7 --beamspot Nominal2025OOCollision --step GEN --nThreads 1 --scenario HeavyIons --geometry DB:Extended --era Run3_2025_OXY --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_2025_OXY_cff import Run3_2025_OXY

process = cms.Process('GEN',Run3_2025_OXY)
...
process.load('IOMC.EventVertexGenerators.VtxSmearedNominal2025OOCollision_cfi')
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/MinBias_Pythia_Angantyr_CP5_OO_5362GeV.py nevts:1'),
...
process.GENoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_Pythia_Angantyr_CP5_OO_5362GeV_py_GEN.root'),
