...
runOnDATA = False ###IMPORTANT: please, to run in MC set to "False"
...
'/store/mc/HINOOSpring25MiniAOD/MinBias_OO_5p36TeV_hijing/MINIAODSIM/NoPU_150X_mcRun3_2025_forOO_realistic_v7-v2/2520000/1ab1ceb3-e0b1-41b9-a9eb-eb243724e4fc.root'
),
...
#mylist = FileUtils.loadListFromFile ('filelist394175x.txt')
#for fname in mylist:
...
if runOnDATA :
   ...
   process.GlobalTag = GlobalTag(process.GlobalTag, '150X_mcRun3_2025_forOO_realistic_v7', '') #centrality table information from this GT for MC
...
# Define the output
process.TFileService = cms.Service("TFileService",fileName = cms.string('oo_miniAOD_sp_gotable_mc.root'))
...
#   srcTracks = cms.InputTag("generalTracks")#,
   etaCutHF = cms.untracked.double(4.0),
   etaCutTrk = cms.untracked.double(2.4),
   etaCutTrkNonC = cms.untracked.double(0.0),
#Vertex selection
...
#Acc X Eff
   ...
   doOO    = cms.untracked.bool(True),
   doNeNe    = cms.untracked.bool(False),
...
process.p = cms.Path(process.demo) # no selection for MC
