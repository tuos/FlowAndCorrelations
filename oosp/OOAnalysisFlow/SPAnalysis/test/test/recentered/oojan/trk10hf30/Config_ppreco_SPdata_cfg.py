...
#'/store/mc/HINOOSpring25MiniAOD/QCD-dijet_Pthat-15_TuneCP5_OO_5p36TeV_pythia8/MINIAODSIM/150X_mcRun3_2025_forOO_realistic_v7-v2/2520000/003b1faf-17a5-424e-af2e-88e2f80d5443.root'
...
#   srcTracks = cms.InputTag("generalTracks")#,
   etaCutHF = cms.untracked.double(3.0),
   etaCutTrk = cms.untracked.double(1.0),
...
process.p = cms.Path(process.demo) # MC no selection
