// -*- C++ -*-
//
// Package:    OOAnalysisFlow/QCAnalysisVn
// Class:      QCAnalysisVn
//
/**\class QCAnalysisVn QCAnalysisVn.cc OOAnalysisFlow/QCAnalysisVn/plugins/QCAnalysisVn.cc
...
class QCAnalysisVn : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
  explicit QCAnalysisVn(const edm::ParameterSet&);
  ~QCAnalysisVn();
...
//
QCAnalysisVn::QCAnalysisVn(const edm::ParameterSet& iConfig) : 
  ...
  rungen_(iConfig.getUntrackedParameter<bool>("rungen"))
{
   ...
   if(cweight_ && !filename.IsNull()){
      edm::FileInPath fip(Form("OOAnalysisFlow/QCAnalysisVn/data/%s",filename.Data()));
...
void QCAnalysisVn::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
/*
...
void QCAnalysisVn::endJob() {
  // please remove this method if not needed
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void QCAnalysisVn::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(QCAnalysisVn);
