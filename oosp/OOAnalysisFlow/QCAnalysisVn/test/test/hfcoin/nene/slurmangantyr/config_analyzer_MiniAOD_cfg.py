...
process.source.lumisToProcess = LumiList.LumiList(filename = '/home/tuos/oopo/data/CMSSW_15_0_9_patch3/src/OOAnalysisFlow/QCAnalysisVn/test/test/hfcoin/nene/slurmangantyr/pre_nene_goodlumis.json').getVLuminosityBlockRange()
