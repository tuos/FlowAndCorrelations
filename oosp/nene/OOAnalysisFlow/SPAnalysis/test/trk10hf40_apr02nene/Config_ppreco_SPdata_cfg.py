...
'/store/hidata/NeNeRun2025/IonPhysics0/MINIAOD/PromptReco-v1/000/394/270/00000/b2bb1e2a-9293-4d0c-9db0-f36fcc5f1735.root'
),
...
# Define the output
process.TFileService = cms.Service("TFileService",fileName = cms.string('nene_miniAOD_sp_gotable.root'))
...
#Acc X Eff
   ...
   #fname = cms.untracked.InputTag('Eff_OO_2025_PythiaHijing_QCD_pThat15_Centrality_fromHihfpf_NoPU_3D_Nominal_Official_18Nov2025.root'),
