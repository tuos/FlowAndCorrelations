...
config.Data.outLFNDirBase = '/store/user/tuos/flowCorr/v04aug08'
config.Data.publication = False
config.Data.outputDatasetTag = 'pbpb2760_flowcorr_v04aug08'
...
if __name__ == '__main__':
   ...
   config.General.workArea = 'pbpb2760_flowcorr_v04aug08'
   ...
   for num in range(0,1):
       ...
       if num == 0:
           RequestName = 'pbpb2760_flowcorr_v04aug08'
           ...
           OutDirBase = '/store/user/tuos/flowCorr/v04aug08'
