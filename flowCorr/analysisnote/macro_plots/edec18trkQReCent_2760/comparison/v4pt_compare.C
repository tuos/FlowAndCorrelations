...
double lymin[Mpads],lymax[Mpads];
  ...
  for (int ip=0;ip<Mpads;ip++)
  {
    ...
    atit[ip][0]="p_{T} (GeV/c)"; atit[ip][1]="v_{4}{#Psi_{4}}";
  }
  //
  ...
  can->cd();
  can->Print("./figures/v4_pt_10cen.png");
  can->Print("./figures/v4_pt_10cen.pdf");
}
