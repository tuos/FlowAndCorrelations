...
TH1D::SetDefaultSumw2();
  ...
  TFile* inFile = new TFile("../flowCorr2760_data_v05dec15_v3TrkEffUW_merged.root");
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    //only Qtrk
    hV4V2starV2starQtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV4V2starV2starQtrk_ibin%d",ibin));
    hV6V2starV2starV2starQtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV6V2starV2starV2starQtrk_ibin%d",ibin));
    hV6V3starV3starQtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV6V3starV3starQtrk_ibin%d",ibin));
    hV5V2starV3starQtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV5V2starV3starQtrk_ibin%d",ibin));
    hV7V2starV2starV3starQtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV7V2starV2starV3starQtrk_ibin%d",ibin));
    hV2Abs4Qtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs4Qtrk_ibin%d",ibin));
    hV2Abs6Qtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs6Qtrk_ibin%d",ibin));
    hV3Abs4Qtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV3Abs4Qtrk_ibin%d",ibin));
    hV2Abs2V3Abs2Qtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs2V3Abs2Qtrk_ibin%d",ibin));
    hV2Abs4V3Abs2Qtrk[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs4V3Abs2Qtrk_ibin%d",ibin));
    //only QtrkHF
    hV4V2starV2starQtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV4V2starV2starQtrkHF_ibin%d",ibin));
    hV6V2starV2starV2starQtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV6V2starV2starV2starQtrkHF_ibin%d",ibin));
    hV6V3starV3starQtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV6V3starV3starQtrkHF_ibin%d",ibin));
    hV5V2starV3starQtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV5V2starV3starQtrkHF_ibin%d",ibin));
    hV7V2starV2starV3starQtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV7V2starV2starV3starQtrkHF_ibin%d",ibin));
    hV2Abs4QtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs4QtrkHF_ibin%d",ibin));
    hV2Abs6QtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs6QtrkHF_ibin%d",ibin));
    hV3Abs4QtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV3Abs4QtrkHF_ibin%d",ibin));
    hV2Abs2V3Abs2QtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs2V3Abs2QtrkHF_ibin%d",ibin));
    hV2Abs4V3Abs2QtrkHF[ibin] = (TH1D*)inFile->Get(Form("flowCorr/hV2Abs4V3Abs2QtrkHF_ibin%d",ibin));
...
// chi
  ...
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    for(int ipt=0; ipt<nPtBin; ipt++){
        value=hv4V2starV2star[ibin][ipt]->GetMean()/hVnAbs4[ibin][1]->GetMean();
        err=value*sqrt(hv4V2starV2star[ibin][ipt]->GetMeanError()*hv4V2starV2star[ibin][ipt]->GetMeanError()/hv4V2starV2star[ibin][ipt]->GetMean()/hv4V2starV2star[ibin][ipt]->GetMean()  + 1.0/1*hVnAbs4[ibin][1]->GetMeanError()*hVnAbs4[ibin][1]->GetMeanError()/hVnAbs4[ibin][1]->GetMean()/hVnAbs4[ibin][1]->GetMean());
      outchi422<<ptBin[ipt]<<"  "<<ptBin[ipt+1]<<"   "<<hMeanPt[ibin][ipt]->GetMean()<<"  "<<hMeanPt[ibin][ipt]->GetEntries()*1.0<<"  "<<value<<"  "<<err<<endl;
    }
  } outchi422.close();
  ofstream outchi422;
  outchi422.open("outchi422_corrFlow.txtHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV4V2starV2star[ibin]->GetMean()/hVnAbs4[ibin][1]->GetMean();
        err=value*sqrt(hV4V2starV2star[ibin]->GetMeanError()*hV4V2starV2star[ibin]->GetMeanError()/hV4V2starV2star[ibin]->GetMean()/hV4V2starV2star[ibin]->GetMean()  + 1.0/1*hVnAbs4[ibin][1]->GetMeanError()*hVnAbs4[ibin][1]->GetMeanError()/hVnAbs4[ibin][1]->GetMean()/hVnAbs4[ibin][1]->GetMean());
      outchi422<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi422.close();
  ofstream outchi422;
  outchi422.open("outchi422_corrFlow.txtQtrkEffW");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV4V2starV2starQtrk[ibin]->GetMean()/hV2Abs4Qtrk[ibin]->GetMean();
        err=value*sqrt(hV4V2starV2starQtrk[ibin]->GetMeanError()*hV4V2starV2starQtrk[ibin]->GetMeanError()/hV4V2starV2starQtrk[ibin]->GetMean()/hV4V2starV2starQtrk[ibin]->GetMean()  + 1.0/1*hV2Abs4Qtrk[ibin]->GetMeanError()*hV2Abs4Qtrk[ibin]->GetMeanError()/hV2Abs4Qtrk[ibin]->GetMean()/hV2Abs4Qtrk[ibin]->GetMean());
      outchi422<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi422.close();
  ofstream outchi422;
  outchi422.open("outchi422_corrFlow.txtQtrkHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV4V2starV2starQtrkHF[ibin]->GetMean()/hV2Abs4QtrkHF[ibin]->GetMean();
        err=value*sqrt(hV4V2starV2starQtrkHF[ibin]->GetMeanError()*hV4V2starV2starQtrkHF[ibin]->GetMeanError()/hV4V2starV2starQtrkHF[ibin]->GetMean()/hV4V2starV2starQtrkHF[ibin]->GetMean()  + 1.0/1*hV2Abs4QtrkHF[ibin]->GetMeanError()*hV2Abs4QtrkHF[ibin]->GetMeanError()/hV2Abs4QtrkHF[ibin]->GetMean()/hV2Abs4QtrkHF[ibin]->GetMean());
      outchi422<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }
  ...
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    for(int ipt=0; ipt<nPtBin; ipt++){
        value=hv5V2starV3star[ibin][ipt]->GetMean()/hV2Abs2V3Abs2[ibin]->GetMean();
        err=value*sqrt(hv5V2starV3star[ibin][ipt]->GetMeanError()*hv5V2starV3star[ibin][ipt]->GetMeanError()/hv5V2starV3star[ibin][ipt]->GetMean()/hv5V2starV3star[ibin][ipt]->GetMean()  + 1.0/1*hV2Abs2V3Abs2[ibin]->GetMeanError()*hV2Abs2V3Abs2[ibin]->GetMeanError()/hV2Abs2V3Abs2[ibin]->GetMean()/hV2Abs2V3Abs2[ibin]->GetMean());
      outchi523<<ptBin[ipt]<<"  "<<ptBin[ipt+1]<<"   "<<hMeanPt[ibin][ipt]->GetMean()<<"  "<<hMeanPt[ibin][ipt]->GetEntries()*1.0<<"  "<<value<<"  "<<err<<endl;
    }
  } outchi523.close();
  ofstream outchi523;
  outchi523.open("outchi523_corrFlow.txtHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
      ...
      outchi523<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi523.close();
  ofstream outchi523;
  outchi523.open("outchi523_corrFlow.txtQtrkEffW");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV5V2starV3starQtrk[ibin]->GetMean()/hV2Abs2V3Abs2Qtrk[ibin]->GetMean();
        err=value*sqrt(hV5V2starV3starQtrk[ibin]->GetMeanError()*hV5V2starV3starQtrk[ibin]->GetMeanError()/hV5V2starV3starQtrk[ibin]->GetMean()/hV5V2starV3starQtrk[ibin]->GetMean()  + 1.0/1*hV2Abs2V3Abs2Qtrk[ibin]->GetMeanError()*hV2Abs2V3Abs2Qtrk[ibin]->GetMeanError()/hV2Abs2V3Abs2Qtrk[ibin]->GetMean()/hV2Abs2V3Abs2Qtrk[ibin]->GetMean());
      outchi523<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi523.close();
  ofstream outchi523;
  outchi523.open("outchi523_corrFlow.txtQtrkHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV5V2starV3starQtrkHF[ibin]->GetMean()/hV2Abs2V3Abs2QtrkHF[ibin]->GetMean();
        err=value*sqrt(hV5V2starV3starQtrkHF[ibin]->GetMeanError()*hV5V2starV3starQtrkHF[ibin]->GetMeanError()/hV5V2starV3starQtrkHF[ibin]->GetMean()/hV5V2starV3starQtrkHF[ibin]->GetMean()  + 1.0/1*hV2Abs2V3Abs2QtrkHF[ibin]->GetMeanError()*hV2Abs2V3Abs2QtrkHF[ibin]->GetMeanError()/hV2Abs2V3Abs2QtrkHF[ibin]->GetMean()/hV2Abs2V3Abs2QtrkHF[ibin]->GetMean());
      outchi523<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }
  ...
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    for(int ipt=0; ipt<nPtBin; ipt++){
        value=hv6V2starV2starV2star[ibin][ipt]->GetMean()/hVnAbs6[ibin][1]->GetMean();
        err=value*sqrt(hv6V2starV2starV2star[ibin][ipt]->GetMeanError()*hv6V2starV2starV2star[ibin][ipt]->GetMeanError()/hv6V2starV2starV2star[ibin][ipt]->GetMean()/hv6V2starV2starV2star[ibin][ipt]->GetMean()  + 1.0/1*hVnAbs6[ibin][1]->GetMeanError()*hVnAbs6[ibin][1]->GetMeanError()/hVnAbs6[ibin][1]->GetMean()/hVnAbs6[ibin][1]->GetMean());
      outchi6222<<ptBin[ipt]<<"  "<<ptBin[ipt+1]<<"   "<<hMeanPt[ibin][ipt]->GetMean()<<"  "<<hMeanPt[ibin][ipt]->GetEntries()*1.0<<"  "<<value<<"  "<<err<<endl;
    }
  } outchi6222.close();
  ofstream outchi6222;
  outchi6222.open("outchi6222_corrFlow.txtHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV6V2starV2starV2star[ibin]->GetMean()/hVnAbs6[ibin][1]->GetMean();
        err=value*sqrt(hV6V2starV2starV2star[ibin]->GetMeanError()*hV6V2starV2starV2star[ibin]->GetMeanError()/hV6V2starV2starV2star[ibin]->GetMean()/hV6V2starV2starV2star[ibin]->GetMean()  + 1.0/1*hVnAbs6[ibin][1]->GetMeanError()*hVnAbs6[ibin][1]->GetMeanError()/hVnAbs6[ibin][1]->GetMean()/hVnAbs6[ibin][1]->GetMean());
      outchi6222<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi6222.close();
  ofstream outchi6222;
  outchi6222.open("outchi6222_corrFlow.txtQtrkEffW");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV6V2starV2starV2starQtrk[ibin]->GetMean()/hV2Abs6Qtrk[ibin]->GetMean();
        err=value*sqrt(hV6V2starV2starV2starQtrk[ibin]->GetMeanError()*hV6V2starV2starV2starQtrk[ibin]->GetMeanError()/hV6V2starV2starV2starQtrk[ibin]->GetMean()/hV6V2starV2starV2starQtrk[ibin]->GetMean()  + 1.0/1*hV2Abs6Qtrk[ibin]->GetMeanError()*hV2Abs6Qtrk[ibin]->GetMeanError()/hV2Abs6Qtrk[ibin]->GetMean()/hV2Abs6Qtrk[ibin]->GetMean());
      outchi6222<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi6222.close();
  ofstream outchi6222;
  outchi6222.open("outchi6222_corrFlow.txtQtrkHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV6V2starV2starV2starQtrkHF[ibin]->GetMean()/hV2Abs6QtrkHF[ibin]->GetMean();
        err=value*sqrt(hV6V2starV2starV2starQtrkHF[ibin]->GetMeanError()*hV6V2starV2starV2starQtrkHF[ibin]->GetMeanError()/hV6V2starV2starV2starQtrkHF[ibin]->GetMean()/hV6V2starV2starV2starQtrkHF[ibin]->GetMean()  + 1.0/1*hV2Abs6QtrkHF[ibin]->GetMeanError()*hV2Abs6QtrkHF[ibin]->GetMeanError()/hV2Abs6QtrkHF[ibin]->GetMean()/hV2Abs6QtrkHF[ibin]->GetMean());
      outchi6222<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }
  ...
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    for(int ipt=0; ipt<nPtBin; ipt++){
        value=hv6V3starV3star[ibin][ipt]->GetMean()/hVnAbs4[ibin][2]->GetMean();
        err=value*sqrt(hv6V3starV3star[ibin][ipt]->GetMeanError()*hv6V3starV3star[ibin][ipt]->GetMeanError()/hv6V3starV3star[ibin][ipt]->GetMean()/hv6V3starV3star[ibin][ipt]->GetMean()  + 1.0/1*hVnAbs4[ibin][2]->GetMeanError()*hVnAbs4[ibin][2]->GetMeanError()/hVnAbs4[ibin][2]->GetMean()/hVnAbs4[ibin][2]->GetMean());
      outchi633<<ptBin[ipt]<<"  "<<ptBin[ipt+1]<<"   "<<hMeanPt[ibin][ipt]->GetMean()<<"  "<<hMeanPt[ibin][ipt]->GetEntries()*1.0<<"  "<<value<<"  "<<err<<endl;
    }
  } outchi633.close();
  ofstream outchi633;
  outchi633.open("outchi633_corrFlow.txtHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV6V3starV3star[ibin]->GetMean()/hVnAbs4[ibin][2]->GetMean();
        err=value*sqrt(hV6V3starV3star[ibin]->GetMeanError()*hV6V3starV3star[ibin]->GetMeanError()/hV6V3starV3star[ibin]->GetMean()/hV6V3starV3star[ibin]->GetMean()  + 1.0/1*hVnAbs4[ibin][2]->GetMeanError()*hVnAbs4[ibin][2]->GetMeanError()/hVnAbs4[ibin][2]->GetMean()/hVnAbs4[ibin][2]->GetMean());
      outchi633<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi633.close();
  ofstream outchi633;
  outchi633.open("outchi633_corrFlow.txtQtrkEffW");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV6V3starV3starQtrk[ibin]->GetMean()/hV3Abs4Qtrk[ibin]->GetMean();
        err=value*sqrt(hV6V3starV3starQtrk[ibin]->GetMeanError()*hV6V3starV3starQtrk[ibin]->GetMeanError()/hV6V3starV3starQtrk[ibin]->GetMean()/hV6V3starV3starQtrk[ibin]->GetMean()  + 1.0/1*hV3Abs4Qtrk[ibin]->GetMeanError()*hV3Abs4Qtrk[ibin]->GetMeanError()/hV3Abs4Qtrk[ibin]->GetMean()/hV3Abs4Qtrk[ibin]->GetMean());
      outchi633<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi633.close();
  ofstream outchi633;
  outchi633.open("outchi633_corrFlow.txtQtrkHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV6V3starV3starQtrkHF[ibin]->GetMean()/hV3Abs4QtrkHF[ibin]->GetMean();
        err=value*sqrt(hV6V3starV3starQtrkHF[ibin]->GetMeanError()*hV6V3starV3starQtrkHF[ibin]->GetMeanError()/hV6V3starV3starQtrkHF[ibin]->GetMean()/hV6V3starV3starQtrkHF[ibin]->GetMean()  + 1.0/1*hV3Abs4QtrkHF[ibin]->GetMeanError()*hV3Abs4QtrkHF[ibin]->GetMeanError()/hV3Abs4QtrkHF[ibin]->GetMean()/hV3Abs4QtrkHF[ibin]->GetMean());
      outchi633<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }
  ...
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    for(int ipt=0; ipt<nPtBin; ipt++){
        value=hv7V2starV2starV3star[ibin][ipt]->GetMean()/hV2Abs4V3Abs2[ibin]->GetMean();
        err=value*sqrt(hv7V2starV2starV3star[ibin][ipt]->GetMeanError()*hv7V2starV2starV3star[ibin][ipt]->GetMeanError()/hv7V2starV2starV3star[ibin][ipt]->GetMean()/hv7V2starV2starV3star[ibin][ipt]->GetMean()  + 1.0/1*hV2Abs4V3Abs2[ibin]->GetMeanError()*hV2Abs4V3Abs2[ibin]->GetMeanError()/hV2Abs4V3Abs2[ibin]->GetMean()/hV2Abs4V3Abs2[ibin]->GetMean());
      outchi7223<<ptBin[ipt]<<"  "<<ptBin[ipt+1]<<"   "<<hMeanPt[ibin][ipt]->GetMean()<<"  "<<hMeanPt[ibin][ipt]->GetEntries()*1.0<<"  "<<value<<"  "<<err<<endl;
    }
  } outchi7223.close();
  ofstream outchi7223;
  outchi7223.open("outchi7223_corrFlow.txtHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
      ...
      outchi7223<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi7223.close();
  ofstream outchi7223;
  outchi7223.open("outchi7223_corrFlow.txtQtrkEffW");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV7V2starV2starV3starQtrk[ibin]->GetMean()/hV2Abs4V3Abs2Qtrk[ibin]->GetMean();
        err=value*sqrt(hV7V2starV2starV3starQtrk[ibin]->GetMeanError()*hV7V2starV2starV3starQtrk[ibin]->GetMeanError()/hV7V2starV2starV3starQtrk[ibin]->GetMean()/hV7V2starV2starV3starQtrk[ibin]->GetMean()  + 1.0/1*hV2Abs4V3Abs2Qtrk[ibin]->GetMeanError()*hV2Abs4V3Abs2Qtrk[ibin]->GetMeanError()/hV2Abs4V3Abs2Qtrk[ibin]->GetMean()/hV2Abs4V3Abs2Qtrk[ibin]->GetMean());
      outchi7223<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }outchi7223.close();
  ofstream outchi7223;
  outchi7223.open("outchi7223_corrFlow.txtQtrkHF");
  for(int ibin=0; ibin<nCentBin; ibin++){
        value=hV7V2starV2starV3starQtrkHF[ibin]->GetMean()/hV2Abs4V3Abs2QtrkHF[ibin]->GetMean();
        err=value*sqrt(hV7V2starV2starV3starQtrkHF[ibin]->GetMeanError()*hV7V2starV2starV3starQtrkHF[ibin]->GetMeanError()/hV7V2starV2starV3starQtrkHF[ibin]->GetMean()/hV7V2starV2starV3starQtrkHF[ibin]->GetMean()  + 1.0/1*hV2Abs4V3Abs2QtrkHF[ibin]->GetMeanError()*hV2Abs4V3Abs2QtrkHF[ibin]->GetMeanError()/hV2Abs4V3Abs2QtrkHF[ibin]->GetMean()/hV2Abs4V3Abs2QtrkHF[ibin]->GetMean());
      outchi7223<<(cBin[ibin] + cBin[ibin+1])/2<<"  "<<value<<"  "<<err<<endl;
  }
