...
TH1D::SetDefaultSumw2();
  ...
  TFile* inFile = new TFile("../../flowCorr_data_5020_v07Ana_5tevReCent_dec18B_mergedB.root");
  for(int ibin=0; ibin<nCentBin; ibin++){
    ...
    for(int ipt=0; ipt<nPtBin; ipt++){
      ...
      hv4V2starV2star[ibin][ipt] = (TH1D*)inFile->Get(Form("flowCorr/hv4V2starV2starAB_ibin%d_ipt%d",ibin,ipt));
      hv6V2starV2starV2star[ibin][ipt] = (TH1D*)inFile->Get(Form("flowCorr/hv6V2starV2starV2starAB_ibin%d_ipt%d",ibin,ipt));
      hv6V3starV3star[ibin][ipt] = (TH1D*)inFile->Get(Form("flowCorr/hv6V3starV3starAB_ibin%d_ipt%d",ibin,ipt));
      hv5V2starV3star[ibin][ipt] = (TH1D*)inFile->Get(Form("flowCorr/hv5V2starV3starAB_ibin%d_ipt%d",ibin,ipt));
      hv7V2starV2starV3star[ibin][ipt] = (TH1D*)inFile->Get(Form("flowCorr/hv7V2starV2starV3starAB_ibin%d_ipt%d",ibin,ipt));
