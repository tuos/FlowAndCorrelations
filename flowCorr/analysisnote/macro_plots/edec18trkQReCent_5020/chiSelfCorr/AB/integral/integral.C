...
void integral(){
  ...
  doIntegral("../outchi422_corrFlow.txt", "./values/chi422_integral.txt");
  doIntegral("../outchi523_corrFlow.txt", "./values/chi523_integral.txt");
  doIntegral("../outchi6222_corrFlow.txt", "./values/chi6222_integral.txt");
  doIntegral("../outchi633_corrFlow.txt", "./values/chi633_integral.txt");
  doIntegral("../outchi7223_corrFlow.txt", "./values/chi7223_integral.txt");
