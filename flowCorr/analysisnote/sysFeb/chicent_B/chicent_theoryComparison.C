...
*/
  ...
  for (int iw=0;iw<nw;iw++)
  {
    ...
    if (iw==3)
    {
      ...
      tex=new TLatex(10.6,4.55*1.1,"Gauss + hydro.");
    ...
    if (iw==3)
    {
      ...
      tex=new TLatex(15.8,4.55*1.1*1.02,"iEBE-VISHNU");
      tex->SetTextSize(textsize*1.0);
      tex->Draw();
    }
    ...
    TLegend *leg2 = new TLegend(lxmin[iw]*0.66*1.4,lymin[iw]*0.99*1.15*0.87,lxmax[iw]*1.0*1.4,lymax[iw]*0.91*1.15*0.87*0.76);
    leg2->SetFillStyle(0);
    leg2->SetFillColor(0);
    leg2->SetTextSize(textsize);
    TLegend *leg3 = new TLegend(lxmin[iw]*0.52*1.2,lymin[iw]*1.05*0.86*0.87*0.95*1.0*0.96,lxmax[iw]*1.0*1.2,lymax[iw]*0.91*0.87*1.05*1.0*0.96);
    //TLegend *leg3 = new TLegend(lxmin[iw]*0.76,lymin[iw]*1.05*0.87,lxmax[iw]*1.1,lymax[iw]*0.91*0.87);
    leg3->SetFillStyle(0);
    leg3->SetFillColor(0);
...
//Error bar line style
      ...
      ge2->SetLineColor(col);
      ge2->Draw("lsame");
      leg3->AddEntry(ge2,"Glb, #eta/s=0.08","l");
    }
    if (iw==2) leg3->Draw();
*/
//OSU
...
//Error bar line style
      ...
      ge2->SetLineColor(col);
      ge2->Draw("lsame");
      leg3->AddEntry(ge2,"KLN, #eta/s=0.08","l");
    }
    //if (iw==2) leg3->Draw();
/*
//AMPT
...
//Data
  ...
  can->cd();
  can->Print("./figures/plot_chicent_theorycompB.png");
  can->Print("./figures/plot_chicent_theorycompB.pdf");
  //can->Print("./figures/plot_chicent_theorycompB.gif");
}
