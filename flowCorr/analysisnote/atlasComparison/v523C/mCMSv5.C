...
nv42Overv44Sys[i]=nv42Overv44[i]*(4.*sqrt(nv44Stat[i]*nv44Stat[i]/nv44[i]/nv44[i] + nv42Stat[i]*nv42Stat[i]/nv42[i]/nv42[i]));
//nv42Overv44Sys[i]=nv42Overv44[i]*(10*(nv42Stat[i]/nv42[i]));
}
...
TGraphErrors *graph_v42Ov44n = new TGraphErrors(nCent-1,npart,nv42Overv44,0,nv42Overv44Sys);
...
graph_v42Ov44n->Draw("pesame");
    ...
    leg0->AddEntry(graph_v42Ov44n,"New CMS v_{5}{#Psi_{23}}/v_{5}{#Psi_{5}}, 5.02 TeV","pl");
    leg0->Draw();
