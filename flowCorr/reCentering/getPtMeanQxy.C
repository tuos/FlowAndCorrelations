...
TH1D::SetDefaultSumw2();
  ...
  TFile* inFile = new TFile("../flowCorr_data_5020_v02Ana_5tevReCent_mar17A_merged.root");
  ...
  ofstream outvhf;
  outvhf.open("outvmeanHFPt_v08_corrFlow.txt");
...
/////////
  ...
  ofstream outvtrk;
  outvtrk.open("outvmeanTrkPt_v08_corrFlow.txt");
