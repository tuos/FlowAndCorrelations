...
// get v2 corrected
  ...
  graph1LG23Minus->SetMarkerSize(1.4);
  ...
  graph2LG23Minus->SetMarkerSize(1.4);
  ...
  graph3LG23Minus->SetMarkerSize(1.4);
  ...
  graph4LG23Minus->SetMarkerSize(1.4);
