...
// read v2 values plus
  ifstream inputV2;
  inputV2.open("txt_v2_N_LG4_charge1_standard.txt");
    ...
    inputV2.close();
  inputV2.open("txt_v2_N_LG23_charge1_standard.txt");
    for(int i=0; i<nCentBin; i++){
      for(int j=0; j<nPtBin; j++){
        inputV2>>tmp;
        inputV2>>tmp;
...
// read minus
  inputV2.open("txt_v2_N_LG4_charge0_standard.txt");
    for(int i=0; i<nCentBin; i++){
      for(int j=0; j<nPtBin; j++){
        inputV2>>tmp;
        inputV2>>ptValues[i][j];
    ...
    inputV2.close();
  inputV2.open("txt_v2_N_LG23_charge0_standard.txt");
    for(int i=0; i<nCentBin; i++){
      for(int j=0; j<nPtBin; j++){
        inputV2>>tmp;
        inputV2>>tmp;
...
// get v2 corrected
  ...
  tex1s->DrawLatex(0.2,0.78,"North");
