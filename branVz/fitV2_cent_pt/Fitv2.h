...
// Wed Mar 23 14:30:50 2022 by ROOT version 5.34/36
...
#ifdef Fitv2_cxx
Fitv2::Fitv2(TTree *tree) : fChain(0) 
{
...
Int_t Fitv2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Fitv2::LoadTree(Long64_t entry)
{
...
void Fitv2::Show(Long64_t entry)
{
...
Int_t Fitv2::Cut(Long64_t entry)
{
