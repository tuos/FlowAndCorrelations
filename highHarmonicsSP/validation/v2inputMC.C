...
void v2inputMC(){
  ...
  TH1D *hdphi = new TH1D("dphi","deltaphi",2000,-0.3,0.3);
  ...
  for(int i=0; i<nEvent; i++){
    ...
    for(int j=0; j<mult; j++){
      ...
      //cout<<"dphi = "<<newPhi-phi0<<endl;      
      hdphi->Fill(newPhi-phi0);
