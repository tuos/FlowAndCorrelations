...
void ptDepv2inputMC(){
  ...
  for(int i=0; i<nEvent; i++){
   ...
   sumwMinus=0;
    ...
    for(int iH=0; iH<nHarmonics; iH++){
      if(sumwPlus>0) { QhfPlus[iH]=QhfPlus[iH]/sumwPlus; }
      else { QhfPlus[iH]=0; }
      if(sumwMinus>0) { QhfMinus[iH]=QhfMinus[iH]/sumwMinus; }
      else { QhfMinus[iH]=0; }
      for(int iPt=0; iPt<nPtBin; iPt++){
        if(sumwPlusTrk[iPt]>0) { QtrkPtPlus[iH][iPt]=QtrkPtPlus[iH][iPt]/sumwPlusTrk[iPt]; }
        else {QtrkPtPlus[iH][iPt]=0; }
        if(sumwMinusTrk[iPt]>0) { QtrkPtMinus[iH][iPt]=QtrkPtMinus[iH][iPt]/sumwMinusTrk[iPt]; }
