void figure_v2input_sp(){
 ...
 hist->Draw();
  ...
  gr2->Draw("psameezL");
    ...
    leg->AddEntry(v2vsPt,"Input v_{2} function","l");
    leg->AddEntry(gr1,"Input v_{2} ","pl");
    leg->AddEntry(gr2,"v_{2}{SP} ","pl");
    leg->Draw();
  ...
  c1->Print("plot_ptDepv2input_sp.png");
  c1->Print("plot_ptDepv2input_sp.pdf");
