...
config.General.requestName = 'PbPbMB0FileBased_2pc_May24'
...
config.Data.outLFNDirBase = '/store/user/tuos/qm2023/anaMay24/PbPbMB0FileBased_2pc_May24'
config.Data.publication = False
config.Data.outputDatasetTag = 'PbPbMB0FileBased_2pc_May24'
