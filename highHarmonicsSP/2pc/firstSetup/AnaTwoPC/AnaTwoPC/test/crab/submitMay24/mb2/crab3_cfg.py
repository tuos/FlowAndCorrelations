...
config.General.requestName = 'PbPbMB2Automatic_2pc_May24'
...
config.Data.outLFNDirBase = '/store/user/tuos/qm2023/anaMay24/PbPbMB2Automatic_2pc_May24'
config.Data.publication = False
config.Data.outputDatasetTag = 'PbPbMB2Automatic_2pc_May24'
