...
// not used
double *getSystValues(TString txtFileName){
  static double sysy_array[400];
  Char_t buffer[2048];
  Float_t tmp, sysy;
  Int_t nlines = 0;
  ifstream infile(txtFileName.Data());
...
void drawSysBoxValue(TGraph* gr, int fillcolor=TColor::GetColor("#ffff00"), double xwidth=0.3, double *percent=0, double xshift=0)
{
  TBox* box;
