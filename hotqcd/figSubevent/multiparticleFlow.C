...
void multiparticleFlow()
{
  ...
  drawSysBoxValue(graph[3],16,2.0, sysValues[3]);
  ...
  leg1->AddEntry(graph[2],"v_{2}{4, 3-sub}","pl");
  leg1->AddEntry(graph[3],"v_{2}{6}","pl");
  leg1->Draw();
  ...
  drawSysBoxValue(graph[7],16,4.0, sysValues[7]);
  drawSysBoxValue(graph[8],16,4.0, sysValues[8]);
  ...
  leg2->AddEntry(graph[4],"v_{2}{2, |#Delta#eta|>2}","pl");
  leg2->AddEntry(graph[5],"v_{2}{4}","pl");
  leg2->AddEntry(graph[6],"v_{2}{4, 3-sub}","pl");
  leg2->AddEntry(graph[7],"v_{2}{6}","pl");
  leg2->AddEntry(graph[8],"v_{2}{8}","pl");
  leg2->Draw();
  ...
  drawSysBoxValue(graph[12],16,3.5, sysValues[12]);
  drawSysBoxValue(graph[13],16,3.5, sysValues[13]);
  ...
  leg3->AddEntry(graph[13],"v_{2}{LYZ}","pl");
  leg3->Draw();
  ...
  drawSysBoxValue(graph[15],16,0.5, sysValues[15]);
  drawSysBoxValue(graph[16],16,0.5, sysValues[16]);
  graph[14]->Draw("pezsame");
  graph[15]->Draw("pezsame");
  graph[16]->Draw("pezsame");
  TLegend *leg4 = new TLegend(0.67,0.75,0.98,0.950);
  leg4->SetFillStyle(0);
  leg4->SetFillColor(0);
  leg4->SetTextSize(0.048);
  leg4->SetBorderSize(0);
  leg4->AddEntry(graph[14],"v_{2}{2, FVTX}","pl");
  leg4->AddEntry(graph[15],"v_{2}{4}","pl");
  leg4->AddEntry(graph[16],"v_{2}{6}","pl");
  leg4->Draw();
  ...
  c1->SaveAs("./plot_multiparticleFlowSub.png");
  c1->SaveAs("./plot_multiparticleFlowSub.pdf");
