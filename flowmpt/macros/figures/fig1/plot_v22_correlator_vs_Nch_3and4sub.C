void plot_v22_correlator_vs_Nch_3and4sub() {
  ...
  in1>>Nch_2[i]; in1>>rho_2[i]; in1>>rhoe_2[i];
...
////////
 ...
 hist->SetYTitle("#rho(v_{2}{2}^{2}, [p_{T}]) or #rho(c_{2}{2}, [p_{T}])");
 //hist->SetMinimum(-0.001);
 //hist->SetMaximum(0.0005);
 hist->SetMinimum(-0.399);
 hist->SetMaximum(0.499);
 ...
 hist->Draw();
  ...
  //gr4->Draw("psameezL");
    ...
    TLatex *tex1 = new TLatex(72,0.41,"PYTHIA8 13 TeV");
    tex1->SetTextColor(1);
    tex1->SetTextSize(0.045);
    tex1->SetTextFont(42);
    tex1->Draw();
    TLatex *tex2 = new TLatex(72,0.33,"0.3 < p_{T} < 2 GeV");
    tex2->SetTextColor(1);
    ...
    TLegend *leg = new TLegend(0.57,0.7,0.77,0.78);
    leg->SetFillColor(10);
    leg->SetBorderSize(0);
    leg->SetTextFont(42);
    leg->SetTextColor(1);
    ...
    leg->AddEntry(gr2,"Two subevents","pl");
