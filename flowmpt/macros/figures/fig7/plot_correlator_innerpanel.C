void plot_correlator_innerpanel() {
...
////////
 ...
 hist->Draw();
  ...
  TPad *p_0_0 = new TPad("p_0_0", "p_0_0",0.185,0.17,0.56,0.46);
  p_0_0->SetLeftMargin(0.01);
  p_0_0->SetRightMargin(0.01);
  p_0_0->SetTopMargin(0.01);
  p_0_0->SetBottomMargin(0.01);
  p_0_0->SetTicks(-1);
  p_0_0->Draw();
  p_0_0->cd();
  ...
  hist2->GetYaxis()->SetLabelSize(0.0);
  hist2->Draw("same");
  gr2->Draw("psameez");
  ...
  gr4->SetLineColor(4);
  gr4->Draw("psameez");
    TLegend *leg2 = new TLegend(0.1,0.7,0.52,0.94);
