void plot_v22_correlator_vs_Nch_3and4sub_times10() {
...
//  }
  in2>>Nchc2[i];
  in2>>tmp; c2[i] = tmp*mult_factor;
  in2>>tmp; c2e[i] = tmp*mult_factor;
...
////////
 ...
 hist->Draw();
  ...
  TGraphErrors *gr3 = new TGraphErrors(nMultBin-2,Nchc2,c2,0,c2e); //nMultBin-2
  gr3->SetTitle("");
  ...
  gr3->Draw("psameez");
    ...
    TLatex *tex1 = new TLatex(75,0.55,"PYTHIA8 13 TeV");
    tex1->SetTextColor(1);
    tex1->SetTextSize(0.045);
    tex1->SetTextFont(42);
    tex1->Draw();
    TLatex *tex2 = new TLatex(75,0.45,"0.3 < p_{T} < 2 GeV");
    tex2->SetTextColor(1);
    ...
    TLegend *leg = new TLegend(0.22,0.8,0.42,0.94);
    leg->SetFillColor(10);
    leg->SetBorderSize(0);
    leg->SetTextFont(42);
    leg->SetTextColor(1);
    ...
    leg->AddEntry(gr3,"#rho(c_{2}{4},[p_{T}]) #times 10","pl");
