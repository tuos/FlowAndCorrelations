...
with open("./eventFile_data_noHead.txt") as inputFile:
...
hp.mollview(hp_smoothed, nest=False, xsize = SIZE, cmap=cm.jet, title='CMS UCC smoothed') #jet/rainbow/seismic/bwr; norm="hist"/LogNorm()
hp.graticule()
#plt.savefig("plot_uccData_3149m_smoothed.png", dpi = DPI)
#plt.savefig("plot_uccData_allEvents_withnormhist_smoothed.png", dpi = DPI)
